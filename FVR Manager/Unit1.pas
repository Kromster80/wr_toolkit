...
begin
//CarsDB
for j:=1 to TB[6].Entries do begin
...
//_3DCarsDB
for j:=1 to TB[7].Entries do begin
...
Value[6,5,ID].Int:=2500;//EC_Value[i,2,5,2].Int;                      //Score
Value[6,6,ID].Int:=1;//EC_Value[i,2,6,2].Int;                      //
Value[6,7,ID].Int:=0;                                          //ReleaseByCaseID
Value[6,8,ID].Int:=9;//EC_Value[i,2,8,2].Int;                      //CarClassID
Value[6,9,ID].Int:=EC_Value[i,2,9,2].Int;                      //
Value[6,10,ID].Int:=EC_Value[i,2,10,2].Int;                     //
Value[6,11,ID].Int:=EC_Value[i,2,11,2].Int;                    //   }
Value[6,12,ID].Int:=(ID-StockCars+StockMotors)-1;                                 //MotorID
Value[6,13,ID].Int:=(ID-StockCars+StockGears)-1;                                 //
Value[6,14,ID].Int:=((ID-StockCars)*2+StockTires-1)-1;                               //
Value[6,15,ID].Int:=((ID-StockCars)*2+StockTires  )-1;                               //
...
Value[6,47,ID].Str:=EC_Value[i,2,107,2].Str;                    //Caravan
Value[6,48,ID].Str:=EC_Value[i,2,105,2].Str;                    //HerstellerName
//Value[6,49,ID].Str:=
//Value[6,50,ID].Str:=
//Value[6,51,ID].Str:=
//52 mocod
...
Value[8,2,(ID-StockCars+StockMotors)].Int:=(ID-StockCars+StockMotors)-1;             //
Value[8,3,(ID-StockCars+StockMotors)].Int:=EC_Value[i,2,50,2].Int;//
Value[8,4,(ID-StockCars+StockMotors)].Rel:=EC_Value[i,2,51,2].Rel;//
Value[8,5,(ID-StockCars+StockMotors)].Rel:=EC_Value[i,2,52,2].Rel;//
Value[8,6,(ID-StockCars+StockMotors)].Rel:=EC_Value[i,2,53,2].Rel;//
Value[8,7,(ID-StockCars+StockMotors)].Rel:=EC_Value[i,2,54,2].Rel;//
Value[8,8,(ID-StockCars+StockMotors)].Rel:=EC_Value[i,2,55,2].Rel;//
Value[8,9,(ID-StockCars+StockMotors)].Rel:=EC_Value[i,2,56,2].Rel;//
Value[8,10,(ID-StockCars+StockMotors)].Rel:=EC_Value[i,2,57,2].Rel;//
Value[8,11,(ID-StockCars+StockMotors)].Rel:=EC_Value[i,2,58,2].Rel;//
Value[8,12,(ID-StockCars+StockMotors)].Rel:=EC_Value[i,2,59,2].Rel;//
Value[8,13,(ID-StockCars+StockMotors)].Rel:=EC_Value[i,2,60,2].Rel;//
Value[8,14,(ID-StockCars+StockMotors)].Rel:=EC_Value[i,2,61,2].Rel;//
Value[8,15,(ID-StockCars+StockMotors)].Rel:=EC_Value[i,2,62,2].Rel;//
Value[8,16,(ID-StockCars+StockMotors)].Rel:=EC_Value[i,2,63,2].Rel;//
Value[8,17,(ID-StockCars+StockMotors)].Rel:=EC_Value[i,2,64,2].Rel;//
Value[8,18,(ID-StockCars+StockMotors)].Rel:=EC_Value[i,2,65,2].Rel;//
Value[8,19,(ID-StockCars+StockMotors)].Rel:=EC_Value[i,2,66,2].Rel;//
Value[8,20,(ID-StockCars+StockMotors)].Rel:=EC_Value[i,2,67,2].Rel;//
Value[8,21,(ID-StockCars+StockMotors)].Rel:=EC_Value[i,2,68,2].Rel;//
Value[8,22,(ID-StockCars+StockMotors)].Rel:=EC_Value[i,2,69,2].Rel;//
Value[8,23,(ID-StockCars+StockMotors)].Rel:=EC_Value[i,2,70,2].Rel;//
Value[8,24,(ID-StockCars+StockMotors)].Rel:=EC_Value[i,2,71,2].Rel;//
Value[8,25,(ID-StockCars+StockMotors)].Rel:=EC_Value[i,2,72,2].Rel;//NMStep
Value[8,26,(ID-StockCars+StockMotors)].Rel:=0;//10500rpm
Value[8,27,(ID-StockCars+StockMotors)].Rel:=0;//11rpm
Value[8,28,(ID-StockCars+StockMotors)].Int:=EC_Value[i,2,75,2].Int;//SampleRate
//Value[8,29,(ID-StockCars+StockMotors)].Int:=EC_Value[i,2,76,2].Int;//MotorSample
Value[8,30,(ID-StockCars+StockMotors)].Int:=EC_Value[i,2,77,2].Int;//
Value[8,31,(ID-StockCars+StockMotors)].Int:=EC_Value[i,2,78,2].Int;//
Value[8,32,(ID-StockCars+StockMotors)].Str:=EC_Value[i,2,79,2].Str;//
Value[8,33,(ID-StockCars+StockMotors)].Str:=EC_Value[i,2,80,2].Str;//
Value[8,34,(ID-StockCars+StockMotors)].Int:=EC_Value[i,2,81,2].Int;//
Value[8,35,(ID-StockCars+StockMotors)].Str:=EC_Value[i,2,82,2].Str;//
Value[8,36,(ID-StockCars+StockMotors)].Int:=EC_Value[i,2,84,2].Int;//Lautstaerke
Value[8,37,(ID-StockCars+StockMotors)].Int:=EC_Value[i,2,101,2].Int;//
Value[8,38,(ID-StockCars+StockMotors)].Int:=EC_Value[i,2,102,2].Int;//
Value[8,39,(ID-StockCars+StockMotors)].Int:=EC_Value[i,2,103,2].Int;//
Value[8,40,(ID-StockCars+StockMotors)].Int:=EC_Value[i,2,104,2].Int;//
Value[8,41,(ID-StockCars+StockMotors)].Int:=EC_Value[i,2,100,2].Int;//Drehzahlmesser
Value[8,42,(ID-StockCars+StockMotors)].Rel:=0;//11.5rpm
Value[8,43,(ID-StockCars+StockMotors)].Rel:=0;//12rpm
Value[8,44,(ID-StockCars+StockMotors)].Rel:=0;//12.5rpm
Value[8,45,(ID-StockCars+StockMotors)].Rel:=0;//13rpm
Value[8,46,(ID-StockCars+StockMotors)].Rel:=0;//13.5rpm
Value[8,47,(ID-StockCars+StockMotors)].Rel:=0;//14rpm
Value[8,48,(ID-StockCars+StockMotors)].Rel:=0;//14.5rpm
Value[8,49,(ID-StockCars+StockMotors)].Rel:=0;//15rpm
//50
//51

//GearboxID
//Value[9,1,ID].Str:= empty
Value[9,2,(ID-StockCars+StockGears)].Int:=(ID-StockCars+StockGears)-1;//
Value[9,3,(ID-StockCars+StockGears)].Int:=EC_Value[i,2,85,2].Int;//
Value[9,4,(ID-StockCars+StockGears)].Rel:=EC_Value[i,2,86,2].Rel;//1
Value[9,5,(ID-StockCars+StockGears)].Rel:=EC_Value[i,2,87,2].Rel;//2
Value[9,6,(ID-StockCars+StockGears)].Rel:=EC_Value[i,2,88,2].Rel;//3
Value[9,7,(ID-StockCars+StockGears)].Rel:=EC_Value[i,2,89,2].Rel;//4
Value[9,8,(ID-StockCars+StockGears)].Rel:=EC_Value[i,2,90,2].Rel;//5
Value[9,9,(ID-StockCars+StockGears)].Rel:=EC_Value[i,2,91,2].Rel;//6
Value[9,10,(ID-StockCars+StockGears)].Rel:=EC_Value[i,2,92,2].Rel;//7
Value[9,11,(ID-StockCars+StockGears)].Rel:=EC_Value[i,2,93,2].Rel;//RW

//Tires
for j:=0 to 1 do begin
//Value[10,1,ID].Str:= empty
Value[10,2,((ID-StockCars)*2+StockTires-j)].Int:=(ID-StockCars)*2+StockTires-j-1;//
Value[10,3,((ID-StockCars)*2+StockTires-j)].Rel:=EC_Value[i,2,94+j*3,2].Rel;//
Value[10,4,((ID-StockCars)*2+StockTires-j)].Rel:=EC_Value[i,2,95+j*3,2].Rel;//
Value[10,5,((ID-StockCars)*2+StockTires-j)].Rel:=EC_Value[i,2,96+j*3,2].Rel;// 
end;    //
...
begin
  AboutForm.Show(VersionInfo,'Manages FVR addon cars','FVRMan');
end;
...
readln(ft,s);
  ...
  repeat
    ...
    for i:=0 to CLBCars.Count-1 do
      if AddonCar[i+1].Folder=s then begin
      CLBCars.Checked[i]:=true;
      AddonCar[i+1].Install:=true;
      end;
  until(s='');
...
begin
  ...
  Form1.Close;
  ChDir(RootDir);
  ShellExecute(handle, 'open', 'FerrariVR.exe', nil, nil, SW_SHOWNORMAL);
end;
